...
@section('content')
    ...
    <div class="modal fade" id="adminSSTambah" tabindex="-1" role="dialog" aria-labelledby="adminSSTambahLabel"
        aria-hidden="true">
    ...
    <div class="modal fade" id="adminSSUpdate" tabindex="-1" role="dialog" aria-labelledby="adminSSUpdateLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
