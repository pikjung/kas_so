        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="dropdown-list dropdown-menu dropdown-menu-left shadow animated--grow-in"
                    ...
                    <a class="dropdown-item d-flex align-items-center" href="/order">
                        <div class="mr-3">
                    ...
                    <a class="dropdown-item d-flex align-items-center" href="/troli">
                        <div class="mr-3">
                    ...
                    <a class="dropdown-item d-flex align-items-center" href="/riwayat_order">
                        <div class="mr-3">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-lg-inline text-light small">Anugrah Elektrik</span>
                            </a>
